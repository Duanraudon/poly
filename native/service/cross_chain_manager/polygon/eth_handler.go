...
type ETHCliHandler struct {
}

func NewETHHandler() *ETHCliHandler {
	return &ETHCliHandler{}
}

func (this *ETHCliHandler) MakeDepositProposal(service *native.NativeService) (*scom.MakeTxParam, error) {
