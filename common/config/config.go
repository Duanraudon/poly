...
var ETH5133_HEIGHT = map[uint32]uint64{
	NETWORK_ID_MAIN_NET: constants.ETH5133_HEIGHT_MAINNET,
}
...
func GetEth5133Height(id uint32) uint64 {
	height, ok := ETH5133_HEIGHT[id]
	if ok {
		return height
	}
	return height
