...
type deleteSealedBlockMsg struct {
	BlockNum uint32 `json:"block_num"`
}

func (msg *deleteSealedBlockMsg) Type() MsgType {
	return DeleteSealedBlockMessage
}

func (msg *deleteSealedBlockMsg) Verify(pub keypair.PublicKey) error {
	return nil
}

func (msg *deleteSealedBlockMsg) GetBlockNum() uint32 {
	return msg.BlockNum
}

func (msg *deleteSealedBlockMsg) Serialize() ([]byte, error) {
	return json.Marshal(msg)
}